 ...
 * Shrimp price increase ; environmental condition change  -> land-unit map change_> land suitability change
 * - Policy of credit : not control, 2.5%; 5%; 10%
 * 
 */
...
global {
	...
	float credited_policy <- 1.0 parameter: true;
